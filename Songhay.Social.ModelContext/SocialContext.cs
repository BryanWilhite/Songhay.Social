...
namespace Songhay.Social.ModelContext
{
    public static class SocialContext
    {
        ...
        public static ICollection<TwitterFavorite> GetTwitterFavorites(IAuthorizer authorizer, Uri baseUri)
        {
            ...
            var favorites = data.Select(i => new TwitterFavorite(i, baseUri)).ToList();
            return favorites;
        }
